    ...
    <div class="control-box">
        <fieldset>
            ...
            <tbody>
                ...
                <tr id="hide_tags_box">
                <th scope="row"><label><?php echo esc_html( __( 'Tags', 'woocommerce-product-list-field-for-contact-form-7' ) ); ?></label></th>
                <td>
                        <?php
                        ...
                        ?>
                       <input type="radio" name="tags" value="<?php echo esc_attr($tag_term->name);?>" class="option"> <?php echo esc_attr($tag_term->name);?>
                        <?php } } ?>
                </td>
                </tr>
                <tr><th><a href="#" target="_blank" class="wplfcf7_pro_link">Go Pro</a></th></tr>
